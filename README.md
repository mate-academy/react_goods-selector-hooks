...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Alessandranitti15.github.io/react_goods-selector/) and add it to the PR description.
